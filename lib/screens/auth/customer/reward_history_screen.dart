...
class _RewardHistoryScreenState extends State<RewardHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (user == null) {
      return Scaffold(
        body: Center(child: Text('User not authenticated'.tr(context))),
      );
    }
          ...
          child: Center(
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  // 1. Top Balance & Membership Progress Card
                  _buildBalanceBanner(context, isDark, status),
                  ...
                  // 3. Transaction Ledger Section Header
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 8),
                    child: Text(
                      'TRANSACTION LEDGER'.tr(context),
                      style: TextStyle(
                  ...
                  // 4. Transactions List View Stream
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.hasError) {
                        ...
                        return Center(
                          child: Padding(
                            ...
                            child: Text(
                              'Unable to load reward history.\nPlease try again later.'.tr(context),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 16),
                                Text(
                                  'No reward transactions yet.'.tr(context),
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                ...
                                Text(
                                  'Complete your first booking to start earning points.'.tr(context),
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          String labelText = 'Points Earned'.tr(context);

                          if (type == 'Redeem') {
                            itemIcon = Icons.shopping_bag_outlined;
                            itemColor = Colors.green;
                            labelText = 'Redeemed Discount'.tr(context);
                          } else if (type == 'Adjustment') {
                            itemIcon = points >= 0
                                ? Icons.card_giftcard_rounded
                                : Icons.exposure_minus_1_rounded;
                            itemColor = points >= 0 ? Colors.blue : Colors.redAccent;
                            labelText = (points >= 0 ? 'Admin Credit' : 'Admin Debit').tr(context);
                          }
  ...
  Widget _buildBalanceBanner(BuildContext context, bool isDark, MembershipStatus status) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Column(
                ...
                children: [
                  Text(
                    'TOTAL REWARD BALANCE'.tr(context),
                    style: const TextStyle(
                  ...
                  _loadingBalance
                      ...
                      : Directionality(
                          textDirection: ui.TextDirection.ltr,
                          child: Text(
                            '$_currentPoints ${'Points'.tr(context)}',
                            style: const TextStyle(
                              color: Colors.white,
                              fontSize: 26,
                              fontWeight: FontWeight.w900,
              ...
              Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      status.currentLevel.toUpperCase().tr(context),
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 9,
                        fontWeight: FontWeight.bold,
          ...
          // Next Level Tier Progress Bar
          const SizedBox(height: 16),
          if (status.nextLevel != 'Maximum Level Reached') ...[
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(
                  '${'Progress to'.tr(context)} ${status.nextLevel.tr(context)} ${'Tier'.tr(context)}',
            ...
            Directionality(
              textDirection: ui.TextDirection.ltr,
              child: Text(
                '${status.pointsNeededForNext} ${'points needed to reach'.tr(context)} ${status.nextLevel.tr(context)}',
            ...
            Row(
              children: [
                ...
                Text(
                  'Maximum Level Reached'.tr(context),
  ...
  Widget _buildMembershipTiersGrid(BuildContext context, bool isDark, MembershipStatus status) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'MEMBERSHIP TIER STATUS'.tr(context),
            style: const TextStyle(
              fontSize: 10,
              fontWeight: FontWeight.bold,
              color: Colors.grey,
          ...
          Column(
            children: tiers.map((tier) {
              ...
              final isCurrent = status.currentLevel == tierName;
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            (tier['benefits'] as String).tr(context),
                            style: TextStyle(
                              fontSize: 10,
                              color: isCurrent 
