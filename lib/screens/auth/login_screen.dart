                      ...
                      children: [
                        Expanded(
                          child: OutlinedButton.icon(
                            ...
                            icon: const Icon(Icons.person_outline, size: 18, color: AppColors.primaryOrange),
                            label: const Text('Customer Bypass', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                            onPressed: () {
                        ...
                        Expanded(
                          child: OutlinedButton.icon(
                            ...
                            icon: const Icon(Icons.admin_panel_settings_outlined, size: 18, color: AppColors.primaryOrange),
                            label: const Text('Admin Bypass', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                            onPressed: () {
                              AuthService.mockUser = MockUser(
                                uid: 'demo_admin',
